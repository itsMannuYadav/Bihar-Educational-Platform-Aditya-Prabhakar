...
from app.db.models.enums import AppLanguage, UserRole, db_enum
...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(
        db_enum(UserRole, "user_role"), nullable=False, default=UserRole.teacher
    )
    school_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("schools.id"))
    preferred_language: Mapped[AppLanguage] = mapped_column(
        db_enum(AppLanguage, "app_language"), nullable=False, default=AppLanguage.hi
    )
